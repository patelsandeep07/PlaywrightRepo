import type { VersionInfo, RunConfig, WorkspaceMetaData, TenantInfo } from "../common/types.js";
...
export declare function resolveTenantDomain(tenantId: string | undefined, tenants: TenantInfo[]): string | undefined;
export declare function getPortalTestRunUrl(workspaceMetadata: WorkspaceMetaData | null, tenantDomain?: string): string;
